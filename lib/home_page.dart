                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      title: const Text("253432432423", style: TextStyle(color: Colors.white)),
                      subtitle: const Text(
                        "Fresh rates",
                    ...
                    const Row(
                      ...
                      children: [
                        ...
                        Text("", style: TextStyle(color: Colors.greenAccent, fontSize: 12)),
                      ],
                    ),
                    const Gap(10),
                    Row(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: BlocBuilder<CurrensyBloc, CurrensyState>(
                  ...
                  Expanded(
                    child: Center(
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            BlocProvider.of<CurrensyBloc>(context)
                                .add(OnGenerate(from: _currency1.code, to: _currency2.code));
                            setState(() {});
                          },
                          style: ElevatedButton.styleFrom(
